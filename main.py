...
style_dropdown = ctk.CTkComboBox(input_frame, values=["Realistic", "Cartoon", "3D Illustration", "Flat Art", "Origami", "Cyberpunk", "Renaissance", "Hologram", "Surreal", "Impressionism", "Fantasy", "Logo Generator"])
